...
public class CompetitorService {
    ...
    public Response createCompetitor(CompetitorDTO competitor) {
        ...
        } catch (Throwable t) { t.printStackTrace(); if (entityManager.getTransaction().isActive()) { entityManager.getTransaction().rollback(); } competitorTmp = null; } finally { entityManager.clear(); entityManager.close(); }
